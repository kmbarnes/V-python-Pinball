...
def make_barriers():
 ...
 #    w0 = box(pos=(-37,2.5,14), axis=(.5,0,1), length=12, width=1, height=2, color=color.white)
 #    w1 = box(pos=(-39.5,2.5,3), axis=(.15,0,1), length=12, width=1, height=2, color=color.white)
#     w2 = box(pos=(-38.75,2.5,-8), axis=(-.15,0,1), length=12, width=1, height=2, color=color.white)
#     w3 = box(pos=(-35,2.5,-18), axis=(-.5,0,1), length=12, width=1, height=2, color=color.white)
#     w4 = box(pos=(-35,2.5,-25), axis=(-.5,0,1), length=12, width=1, height=2, color=color.white)
     #w5 = box(pos=(-35,2.5,-18), axis=(-.5,0,1), length=12, width=1, height=2, color=color.white)
     #w6 = box(pos=(-35,2.5,-18), axis=(-.5,0,1), length=12, width=1, height=2, color=color.white)
#     w7 = box(pos=(36.5,2.5,-15), axis=(.5,0,1), length=5, width=1, height=2, color=color.white)
#     w8 = box(pos=(38.75,2.5,-8), axis=(.15,0,1), length=12, width=1, height=2, color=color.white)
#     w9 = box(pos=(39.5,2.5,3), axis=(-.15,0,1), length=12, width=1, height=2, color=color.white)
#     w10 = box(pos=(37,2.5,14), axis=(-.5,0,1), length=12, width=1, height=2, color=color.white)
...
def make_alien():
    ...
    """
    alien = frame( pos=(10,2.5,-12) )  # makes a new "frame" == a container
...
def main():
     ...
     while True:
            ...
            #
            if mag(pos.ball) == 40:
                if pos.ball.x < 3 and pos.ball.z < 20:
                   vel.ball = rotate(vel.ball, angle=.5*pi, axis=(1,0,1)) 
                elif pos.ball.x > 35 and pox.ball.z < 20:
            #   vel.ball == rotate(vel.ball, angle=.5*pi, axis=(1,0,1))
            #
            #
            #
